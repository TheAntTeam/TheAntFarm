...
class UiAbout(QObject):
    ...
    def show_about_info(self):
        ...
        grid.addWidget(credits_2_la, 1, 1, 1, 1, alignment=Qt.AlignCenter | Qt.AlignVCenter)
        ...
        grid.addWidget(repo_la, 3, 1, 1, 1, alignment=Qt.AlignCenter | Qt.AlignVCenter)
