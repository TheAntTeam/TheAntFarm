...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.drill_tw.setSelectionBehavior(QAbstractItemView.SelectionBehavior.SelectItems)
        self.drill_tw.setColumnCount(2)
        ...
        self.gcode_tw.setHorizontalScrollBarPolicy(Qt.ScrollBarPolicy.ScrollBarAsNeeded)
        self.gcode_tw.setSelectionMode(QAbstractItemView.SelectionMode.NoSelection)
        self.gcode_tw.setSelectionBehavior(QAbstractItemView.SelectionBehavior.SelectItems)
        ...
        self.jog_probe_tab_widget.setTabPosition(QTabWidget.TabPosition.North)
        ...
        self.z_step_val_dsb.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.UpDownArrows)
        ...
        self.xy_step_val_dsb.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.UpDownArrows)
        ...
        sizePolicy9.setHeightForWidth(self.abl_active_chb.sizePolicy().hasHeightForWidth())
        self.abl_active_chb.setSizePolicy(sizePolicy9)
        ...
        sizePolicy10.setHeightForWidth(self.min_l.sizePolicy().hasHeightForWidth())
        self.min_l.setSizePolicy(sizePolicy10)
        ...
        self.x_min_dsb.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.UpDownArrows)
        ...
        self.x_max_dsb.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.UpDownArrows)
        ...
        self.x_step_dsb.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.UpDownArrows)
        ...
        self.y_min_dsb.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.UpDownArrows)
        ...
        self.y_max_dsb.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.UpDownArrows)
        ...
        self.y_step_dsb.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.UpDownArrows)
        ...
        self.z_min_dsb.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.UpDownArrows)
        ...
        self.z_max_dsb.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.UpDownArrows)
        ...
        self.serial_te.setVerticalScrollBarPolicy(Qt.ScrollBarPolicy.ScrollBarAsNeeded)
        self.serial_te.setTextInteractionFlags(Qt.TextInteractionFlag.NoTextInteraction)
        ...
        sizePolicy12.setHeightForWidth(self.send_pb.sizePolicy().hasHeightForWidth())
        self.send_pb.setSizePolicy(sizePolicy12)
        ...
        self.connectVerticalLayout.setContentsMargins(0, 0, 0, 0)
        ...
        self.verticalLayout_17.addLayout(self.connectVerticalLayout)
        ...
        sizePolicy3.setHeightForWidth(self.clear_terminal_pb.sizePolicy().hasHeightForWidth())
        self.clear_terminal_pb.setSizePolicy(sizePolicy3)
        ...
        self.status_l.setFrameShape(QFrame.Shape.NoFrame)
        ...
        self.tool_or_camera_tb.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonIconOnly)
        ...
        self.gridLayoutDirections_2.setSizeConstraint(QLayout.SizeConstraint.SetDefaultConstraint)
        ...
        self.z_step_val_dsb_2.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.UpDownArrows)
        ...
        self.xy_step_val_dsb_2.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.UpDownArrows)
        ...
        self.flip_horizontally_tb.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonIconOnly)
        ...
        self.flip_vertically_tb.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonIconOnly)
        ...
        self.align_points_tw.setSizeAdjustPolicy(QAbstractScrollArea.SizeAdjustPolicy.AdjustIgnored)
        self.align_points_tw.setColumnCount(4)
        ...
        self.add_point_tb.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonIconOnly)
        ...
        self.remove_point_tb.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonIconOnly)
        ...
        self.serial_error_warning_threshold_sb.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.UpDownArrows)
        ...
        self.serial_error_critical_threshold_sb.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.UpDownArrows)
        ...
        self.bottom_layer_color_la.setFrameShape(QFrame.Shape.NoFrame)
        ...
        self.top_layer_color_la.setFrameShape(QFrame.Shape.NoFrame)
        ...
        self.profile_layer_color_la.setFrameShape(QFrame.Shape.NoFrame)
        ...
        self.drill_layer_color_la.setFrameShape(QFrame.Shape.NoFrame)
        ...
        self.nc_top_layer_color_la.setFrameShape(QFrame.Shape.NoFrame)
        ...
        self.nc_bottom_layer_color_la.setFrameShape(QFrame.Shape.NoFrame)
        ...
        self.tool_probe_y_wpos_dsb.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.UpDownArrows)
        ...
        self.tool_probe_y_mpos_dsb.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.UpDownArrows)
        ...
        self.tool_probe_z_limit_dsb.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.UpDownArrows)
        ...
        self.tool_probe_x_wpos_dsb.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.UpDownArrows)
        ...
        self.tool_probe_x_mpos_dsb.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.UpDownArrows)
        ...
        self.tool_probe_z_mpos_dsb.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.UpDownArrows)
        ...
        self.tool_probe_z_wpos_dsb.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.UpDownArrows)
        ...
        self.tool_change_z_mpos_dsb.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.UpDownArrows)
        ...
        self.tool_change_y_mpos_dsb.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.UpDownArrows)
        ...
        self.tool_change_x_mpos_dsb.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.UpDownArrows)
        ...
        self.x_tool_camera_offset_dsb.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.UpDownArrows)
        ...
        self.y_tool_camera_offset_dsb.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.UpDownArrows)
        ...
        self.flip_cam_h_chb.setLayoutDirection(Qt.LayoutDirection.LeftToRight)

        self.gridLayout_17.addWidget(self.flip_cam_h_chb, 4, 2, 1, 1, Qt.AlignmentFlag.AlignHCenter)
        ...
        self.flip_cam_v_chb.setLayoutDirection(Qt.LayoutDirection.LeftToRight)
        ...
        self.camera_rotation_dsb.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.UpDownArrows)
        ...
        sizePolicy11.setHeightForWidth(self.logging_plain_te.sizePolicy().hasHeightForWidth())
        self.logging_plain_te.setSizePolicy(sizePolicy11)
...
#if QT_CONFIG(statustip)
        self.apply_alignment_tb_2.setStatusTip(QCoreApplication.translate("MainWindow", u"Alignment OFF", None))
#endif // QT_CONFIG(statustip)
...
#if QT_CONFIG(statustip)
        self.add_point_tb.setStatusTip(QCoreApplication.translate("MainWindow", u"Add alignment point", None))
#endif // QT_CONFIG(statustip)
        self.add_point_tb.setText(QCoreApplication.translate("MainWindow", u"+", None))
#if QT_CONFIG(statustip)
        self.remove_point_tb.setStatusTip(QCoreApplication.translate("MainWindow", u"Remove alignment point", None))
#endif // QT_CONFIG(statustip)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.apply_alignment_tb.setStatusTip(QCoreApplication.translate("MainWindow", u"Alignment OFF", None))
#endif // QT_CONFIG(statustip)
