...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.alignment_led_la = QLedLabel(self.control_tab)
        self.alignment_led_la.setObjectName(u"alignment_led_la")
        sizePolicy3.setHeightForWidth(self.alignment_led_la.sizePolicy().hasHeightForWidth())
        self.alignment_led_la.setSizePolicy(sizePolicy3)
        self.alignment_led_la.setMinimumSize(QSize(30, 30))

        self.horizontalLayout_22.addWidget(self.alignment_led_la)
...
#if QT_CONFIG(tooltip)
        self.alignment_led_la.setToolTip(QCoreApplication.translate("MainWindow", u"Alignment not applied", None))
#endif // QT_CONFIG(tooltip)
        self.alignment_led_la.setText("")
#if QT_CONFIG(statustip)
