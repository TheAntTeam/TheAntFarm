...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.z_step_cb.setMinimumSize(QSize(75, 18))
        self.z_step_cb.setMaximumSize(QSize(75, 23))
...
#if QT_CONFIG(tooltip)
        self.abl_active_chb.setToolTip("")
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.abl_active_chb.setStatusTip(QCoreApplication.translate("MainWindow", u"Apply ABL if checked", None))
#endif // QT_CONFIG(statustip)
