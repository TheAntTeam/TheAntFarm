...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        QWidget.setTabOrder(self.nc_bottom_generate_pb, self.zero_xyz_pushButton)
        QWidget.setTabOrder(self.zero_xyz_pushButton, self.zero_x_pushButton)
        QWidget.setTabOrder(self.zero_x_pushButton, self.zero_y_pushButton)
        QWidget.setTabOrder(self.zero_y_pushButton, self.zero_z_pushButton)
        QWidget.setTabOrder(self.zero_z_pushButton, self.unlockButton)
        QWidget.setTabOrder(self.unlockButton, self.homingButton)
        QWidget.setTabOrder(self.homingButton, self.xYMinusPlusButton)
        QWidget.setTabOrder(self.xYMinusPlusButton, self.yPlusButton)
        QWidget.setTabOrder(self.yPlusButton, self.xYPlusButton)
        QWidget.setTabOrder(self.xYPlusButton, self.xMinusButton)
        QWidget.setTabOrder(self.xMinusButton, self.centerButton)
        QWidget.setTabOrder(self.centerButton, self.xPlusButton)
        QWidget.setTabOrder(self.xPlusButton, self.xYMinusButton)
        QWidget.setTabOrder(self.xYMinusButton, self.yMinusButton)
        QWidget.setTabOrder(self.yMinusButton, self.xYPlusMinuButton)
        QWidget.setTabOrder(self.xYPlusMinuButton, self.doubleSpinBox_2)
        QWidget.setTabOrder(self.doubleSpinBox_2, self.doubleSpinBox)
        QWidget.setTabOrder(self.doubleSpinBox, self.zPlusButton)
        QWidget.setTabOrder(self.zPlusButton, self.zMinusButton)
        QWidget.setTabOrder(self.zMinusButton, self.serial_te)
        QWidget.setTabOrder(self.serial_te, self.send_text_edit)
        QWidget.setTabOrder(self.send_text_edit, self.send_push_button)
        QWidget.setTabOrder(self.send_push_button, self.serial_ports_cb)
        QWidget.setTabOrder(self.serial_ports_cb, self.serial_baud_cb)
        QWidget.setTabOrder(self.serial_baud_cb, self.refresh_button)
        QWidget.setTabOrder(self.refresh_button, self.autoscroll_chb)
        QWidget.setTabOrder(self.autoscroll_chb, self.clear_terminal_button)
        QWidget.setTabOrder(self.clear_terminal_button, self.connect_button)
        QWidget.setTabOrder(self.connect_button, self.logging_plain_te)
